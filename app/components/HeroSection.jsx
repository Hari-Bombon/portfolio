    ...
    <section>
      ...
      <p className='text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl'>
        ...
        <div>
          ...
          <button className='px-6 py-3 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:big-slate-800 hover:bg-slate-800 text-white border border-white mt-3'>
